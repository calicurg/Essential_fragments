...
ParamsDI = {'source':'Entry__Cl_Ov_telaprevir.txt'}
Accs = {
        0:[],
        1:[]
        }  
...
def Read__source():
    file_name = ParamsDI['source']
    fi = open(file_name, 'r') ##'Entry__ALL_FILES.txt', 'r')
    line = fi.read()
    fi.close()
...
#        inci = v['inci']
    ...
    print 'Get fragments: done'        
        


def WCLAsterisks():
    ''' WCL : word class lattices '''
